...
ItemDisplay[r08]: %RED%¤¤¤¤ %ORANGE%%RUNENAME% %RED%¤¤Sita!!!¤¤ %TAN%[8]
...
ItemDisplay[ID RARE !SOCK=0 !ETH]: %NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[ID RARE !SOCK=0 ETH]: %WHITE%ETH %YELLOW%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[ID SET amu]: %NAME% %TAN%[%ILVL%]
...
ItemDisplay[RARE !ID CL2 !ETH]: %RED%¤¤¤ %YELLOW%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
...
ItemDisplay[RARE !ID gax !ETH]: %YELLOW%%NAME% %TAN%[%ILVL%]
...
ItemDisplay[RARE !ID 9ws !ETH]: %YELLOW%%NAME% %TAN%[%ILVL%]
...
ItemDisplay[SET !ID xml]: %NAME% %TAN%[%ILVL%]
...
ItemDisplay[NMAG SK138>1 SOCK=0 !ETH]: %DGREEN%%NAME% %ORANGE%Shout %RED%[%SOCKETS%] %TAN%[%ILVL%]
...
ItemDisplay[NMAG CL3 SOCK=4 ELT ETH ED>49]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
...
ItemDisplay[NMAG SK68>1 SOCK=2 WP12]: %DGREEN%%NAME% %ORANGE%Bone Armor %RED%[%SOCKETS%] %TAN%[%ILVL%]
...
ItemDisplay[NMAG CL5 SOCK=0 ETH ELT ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
...
ItemDisplay[NMAG SK50>1 SOCK=0 WP11 !sst !lst !8ss !8ls !6ss !6ls]: %DGREEN%%NAME% %ORANGE%Shiver %RED%[%SOCKETS%] %TAN%[%ILVL%]
...
ItemDisplay[NMAG amd SOCK>4 TABSK2=3 ETH !SUP]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Java %RED%[%SOCKETS%] %TAN%[%ILVL%]
...
ItemDisplay[NMAG CL7 SOCK>1 !ETH ILVL<67]:
ItemDisplay[NMAG CL7 SOCK>1 ETH ILVL<67]:
ItemDisplay[NMAG CL7 SOCK>1 ILVL>66]:
ItemDisplay[NMAG CL7 SOCK=0]:
//
//╔═══════════════════════════╗
//║ Equipments Runeword Bases ║
//╚═══════════════════════════╝
//
// EQ1
ItemDisplay[NMAG msk]:
ItemDisplay[NMAG xsk]:
ItemDisplay[NMAG uh9 SOCK=3 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Defense %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG usk SOCK=3 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Defense %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG uh9 SOCK=3]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG usk SOCK=3]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG uhm]:
ItemDisplay[NMAG urn]:
ItemDisplay[NMAG EQ1 SOCK>1 !ETH ELT ED>9]:
ItemDisplay[NMAG EQ1 SOCK>1 ETH ELT ED>9]:
ItemDisplay[NMAG EQ1 SOCK>1 !ETH ILVL<76]:
ItemDisplay[NMAG EQ1 SOCK>1 ETH ILVL<76]:
ItemDisplay[NMAG EQ1 SOCK>1 ILVL>75]:
ItemDisplay[NMAG EQ1 !ETH SOCK=2 CLVL<50]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
// EQ2
ItemDisplay[NMAG uea]:
ItemDisplay[NMAG ula]:
ItemDisplay[NMAG ung]:
ItemDisplay[NMAG ucl]:
ItemDisplay[NMAG urs]:
ItemDisplay[NMAG upl]:
ItemDisplay[NMAG uld]:
ItemDisplay[NMAG ult]:
ItemDisplay[NMAG uth]:
ItemDisplay[NMAG brs]:
ItemDisplay[NMAG ltp SOCK=2 !ETH !SUP]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG ltp SOCK=2 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Defense %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG gth SOCK=3 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Defense %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG aar SOCK>2 !ETH !SUP]: %DGREEN%%NAME% %ORANGE%Defense %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG xrs]:
ItemDisplay[NMAG xtp SOCK=3 !ETH !SUP]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG xtp SOCK=3 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Defense %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG xtp]:
ItemDisplay[NMAG uui SOCK=0 !ETH !SUP DEF>449]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG utu SOCK=0 !ETH !SUP DEF>474]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG utp SOCK=0 !ETH !SUP DEF>499]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG uhn SOCK=0 !ETH !SUP DEF>499]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG ull SOCK=0 !ETH !SUP DEF>534]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG uar SOCK=0 !ETH !SUP DEF>549]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG uui SOCK>2 !ETH !SUP]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG utu SOCK>2 !ETH !SUP DEF>449]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG utp SOCK>2 !ETH !SUP]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG uhn SOCK>2 !ETH !SUP DEF>479]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG ull SOCK>2 !ETH !SUP DEF>529]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG uar SOCK>2 !ETH !SUP DEF>549]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG uui SOCK=0 ETH !SUP DEF>649]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG utu SOCK=0 ETH !SUP DEF>699]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG utp SOCK=0 ETH !SUP DEF>699]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG uhn SOCK=0 ETH !SUP DEF>699]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG ull SOCK=0 ETH !SUP DEF>799]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG uar SOCK=0 ETH !SUP DEF>799]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG uui SOCK>2 ETH !SUP DEF>649]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG utu SOCK>2 ETH !SUP DEF>699]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG utp SOCK>2 ETH !SUP DEF>649]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG uhn SOCK>2 ETH !SUP DEF>699]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG ull SOCK>2 ETH !SUP DEF>799]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG uar SOCK>2 ETH !SUP DEF>799]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG EQ2 EXC]:
ItemDisplay[NMAG EQ2 EXC]:
ItemDisplay[NMAG EQ2 SOCK=0 !ETH ELT ED>9]: %DGREEN%%NAME% %ORANGE%Defense %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG EQ2 SOCK>2 !ETH ELT ED>9]: %DGREEN%%NAME% %ORANGE%Defense %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG EQ2 SOCK=0 ETH ELT ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Defense %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG EQ2 SOCK>2 ETH ELT ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Defense %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG EQ2 SOCK>1 !ETH ILVL<67]:
ItemDisplay[NMAG EQ2 SOCK>1 ETH ILVL<67]:
ItemDisplay[NMAG EQ2 SOCK>1 ILVL>66]:
ItemDisplay[NMAG EQ2 !ETH (SOCK=2 OR SOCK=3 OR SOCK=4) CLVL<30]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG EQ2 ETH (SOCK=2 OR SOCK=3 OR SOCK=4) CLVL<30]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG EQ2 !ETH (SOCK=2 OR SOCK=3 OR SOCK=4) EXC CLVL<70]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG EQ2 ETH (SOCK=2 OR SOCK=3 OR SOCK=4) EXC CLVL<70]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG EQ2 !ETH (SOCK=2 OR SOCK=3 OR SOCK=4) ELT CLVL<90]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG EQ2 ETH (SOCK=2 OR SOCK=3 OR SOCK=4) ELT CLVL<90]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG EQ2]:
// EQ3 SHIELDS
ItemDisplay[NMAG uit SOCK=0 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Defense %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG uit SOCK=4 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Defense %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG uit SOCK=4 !ETH]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG uit SOCK=3 !ETH]:
ItemDisplay[NMAG uit SOCK=0 !ETH]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG uit SOCK=0 ETH ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Defense %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG uit SOCK=4 ETH ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Defense %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG uit SOCK=4 ETH]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG uit SOCK=3 ETH]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG uit SOCK=0 ETH]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG kit SOCK=3 !ETH !SUP]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG kit SOCK=3 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Defense %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG bsh]:
ItemDisplay[NMAG gts]:
ItemDisplay[NMAG xit]:
ItemDisplay[NMAG xsh]:
ItemDisplay[NMAG urg]:
ItemDisplay[NMAG upk]:
ItemDisplay[NMAG ush SOCK=3 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Defense %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG pad]:
ItemDisplay[NMAG xow]:
ItemDisplay[NMAG uts]:
ItemDisplay[NMAG ush]:
ItemDisplay[NMAG EQ3 SOCK>2 !ETH (ELT OR EXC) ED>9]: %DGREEN%%NAME% %ORANGE%Defense %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG EQ3 SOCK>2 ETH (ELT OR EXC) ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Defense %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG EQ3 SOCK>1 !ETH ILVL<67]:
ItemDisplay[NMAG EQ3 SOCK>1 ETH ILVL<67]:
ItemDisplay[NMAG EQ3 SOCK>1 ILVL>66]:
ItemDisplay[NMAG EQ3 !ETH (SOCK=2 OR SOCK=3 OR SOCK=4) CLVL<30]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG EQ3 ETH (SOCK=2 OR SOCK=3 OR SOCK=4) CLVL<30]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG EQ3 !ETH (SOCK=2 OR SOCK=3 OR SOCK=4) EXC CLVL<70]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG EQ3 ETH (SOCK=2 OR SOCK=3 OR SOCK=4) EXC CLVL<70]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG EQ3 !ETH (SOCK=2 OR SOCK=3 OR SOCK=4) ELT CLVL<90]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG EQ3 ETH (SOCK=2 OR SOCK=3 OR SOCK=4) ELT CLVL<90]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG EQ3]:
// EQ7
ItemDisplay[NMAG ci0 SOCK>1 !ETH !SUP DEF=30]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG ci1 SOCK>1 !ETH !SUP DEF=40]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG ci2 SOCK=0 !ETH !SUP]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG ci2 SOCK>1 !ETH !SUP]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG ci3 SOCK=0 !ETH !SUP]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG ci3 SOCK>1 !ETH !SUP]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG EQ7 (SOCK>1 or SOCK=0) !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Defense %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG EQ7 SOCK>1 ETH ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Defense %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG EQ7 SOCK>1 !ETH ILVL<67]:
ItemDisplay[NMAG EQ7 SOCK>1 ETH ILVL<67]:
ItemDisplay[NMAG EQ7 SOCK>1 ILVL>66]:
ItemDisplay[NMAG EQ7 !ETH (SOCK=2 OR SOCK=3) NORM CLVL<60]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG EQ7 ETH (SOCK=2 OR SOCK=3) NORM CLVL<60]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG EQ7 !ETH (SOCK=2 OR SOCK=3)]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG EQ7 ETH (SOCK=2 OR SOCK=3)]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG EQ7]:
//
//╔═══════════════════════╗
//║ Weapon Runeword Bases ║
//╚═══════════════════════╝
//
// WP1
ItemDisplay[NMAG 2ax]:
ItemDisplay[NMAG 2ax]:
ItemDisplay[NMAG mpi]:
ItemDisplay[NMAG mpi]:
ItemDisplay[NMAG 7wa SOCK=0 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7wa SOCK>3 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7wa SOCK=0 ETH ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7wa SOCK>3 ETH ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7wa SOCK=0 !ETH !INF]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7wa SOCK>3 !ETH !INF]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7wa SOCK=0 ETH !INF]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7wa SOCK>3 ETH !INF]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7mp]:
ItemDisplay[NMAG 72a SOCK=0 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 72a SOCK>3 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 72a SOCK=0 ETH ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 72a SOCK>3 ETH ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 72a SOCK=0 !ETH !INF]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 72a SOCK>3 !ETH !INF]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 72a SOCK=0 ETH !INF]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 72a SOCK>3 ETH !INF]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 72a]:
ItemDisplay[NMAG 7ax]:
ItemDisplay[NMAG 7ga]:
ItemDisplay[NMAG 7gi SOCK=0 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7gi SOCK>3 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7gi SOCK=0 ETH ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7gi SOCK>3 ETH ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7gi SOCK=0 !ETH !INF]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7gi SOCK>3 !ETH !INF]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7gi SOCK=0 ETH !INF]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7gi SOCK>3 ETH !INF]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7gi]:
ItemDisplay[NMAG 7bt]:
ItemDisplay[NMAG 7la]:
ItemDisplay[NMAG WP1 SOCK>1 !ETH ILVL<67]:
ItemDisplay[NMAG WP1 SOCK>1 ETH ILVL<67]:
ItemDisplay[NMAG WP1 SOCK>1 ILVL>66]:
ItemDisplay[NMAG WP1 SOCK=0]:
// WP2
ItemDisplay[NMAG fla SOCK>3 !ETH]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG fla SOCK>3 ETH]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG fla]:
ItemDisplay[NMAG 9fl SOCK>3 !ETH]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 9fl SOCK>3 ETH]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 9fl]:
ItemDisplay[NMAG 7fl]:
ItemDisplay[NMAG 7wh]:
ItemDisplay[NMAG 7m7]:
ItemDisplay[NMAG 7gm SOCK=0 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7gm SOCK>3 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7gm SOCK=0 ETH ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7gm SOCK>3 ETH ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7gm SOCK=0 !ETH !INF]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7gm SOCK>3 !ETH !INF]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7gm SOCK=0 ETH !INF]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7gm SOCK>3 ETH !INF]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7gm]:
ItemDisplay[NMAG WP2 SOCK>1 !ETH ILVL<67]:
ItemDisplay[NMAG WP2 SOCK>1 ETH ILVL<67]:
ItemDisplay[NMAG WP2 SOCK>1 ILVL>66]:
ItemDisplay[NMAG WP2 SOCK=0]:
// WP3
ItemDisplay[NMAG bsd]:
ItemDisplay[NMAG crs SOCK>3 !ETH]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG crs SOCK>3 ETH]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG crs]:
ItemDisplay[NMAG 9cr]:
ItemDisplay[NMAG 7cr SOCK=0 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7cr SOCK>3 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7cr SOCK=0 ETH ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7cr SOCK>3 ETH ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7cr SOCK=0 !ETH !INF]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7cr SOCK>3 !ETH !INF]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7cr SOCK=0 ETH !INF]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7cr SOCK>3 ETH !INF]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7cr]:
ItemDisplay[NMAG 7bs]:
ItemDisplay[NMAG 7ls SOCK=0 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7ls SOCK>3 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7ls SOCK=0 ETH ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7ls SOCK>3 ETH ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7ls SOCK=0 !ETH !INF]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7ls SOCK>3 !ETH !INF]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7ls SOCK=0 ETH !INF]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7ls SOCK>3 ETH !INF]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7ls]:
ItemDisplay[NMAG 7wd]:
ItemDisplay[NMAG 72h SOCK=0 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 72h SOCK>3 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 72h SOCK=0 ETH ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 72h SOCK>3 ETH ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 72h SOCK=0 !ETH !INF]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 72h SOCK>3 !ETH !INF]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 72h SOCK=0 ETH !INF]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 72h SOCK>3 ETH !INF]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 72h]:
ItemDisplay[NMAG 7cm]:
ItemDisplay[NMAG 7gs]:
ItemDisplay[NMAG 7b7]:
ItemDisplay[NMAG 7fb SOCK=0 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7fb SOCK>3 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7fb SOCK=0 ETH ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7fb SOCK>3 ETH ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7fb SOCK=0 !ETH !INF]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7fb SOCK>3 !ETH !INF]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7fb SOCK=0 ETH !INF]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7fb SOCK>3 ETH !INF]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7fb]:
ItemDisplay[NMAG 7gd SOCK=0 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7gd SOCK>3 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7gd SOCK=0 ETH ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7gd SOCK>3 ETH ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7gd SOCK=0 !ETH !INF]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7gd SOCK>3 !ETH !INF]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7gd SOCK=0 ETH !INF]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7gd SOCK>3 ETH !INF]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7gd]:
ItemDisplay[NMAG WP3 SOCK>1 !ETH ILVL<67]:
ItemDisplay[NMAG WP3 SOCK>1 ETH ILVL<67]:
ItemDisplay[NMAG WP3 SOCK>1 ILVL>66]:
ItemDisplay[NMAG WP3 SOCK=0]:
// WP4
ItemDisplay[NMAG 7kr]:
ItemDisplay[NMAG WP4 SOCK>1 !ETH ILVL<67]:
ItemDisplay[NMAG WP4 SOCK>1 !ETH ILVL>66]:
ItemDisplay[NMAG WP4 SOCK=0]:
ItemDisplay[NMAG WP4 ETH]:
// WP7
ItemDisplay[NMAG 7tr]:
ItemDisplay[NMAG 7br]:
ItemDisplay[NMAG 7st]:
ItemDisplay[NMAG 7p7 SOCK=0 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7p7 SOCK>3 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7p7 SOCK=0 ETH ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7p7 SOCK>3 ETH ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7p7 SOCK=0 !ETH !INF]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7p7 SOCK>3 !ETH !INF]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7p7 SOCK=0 ETH !INF]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7p7 SOCK>3 ETH !INF]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7p7]:
ItemDisplay[NMAG WP7 SOCK>1 !ETH ILVL<67]:
ItemDisplay[NMAG WP7 SOCK>1 ETH ILVL<67]:
ItemDisplay[NMAG WP7 SOCK>1 ILVL>66]:
ItemDisplay[NMAG WP7 SOCK=0]:
// WP8
ItemDisplay[NMAG 9pa SOCK=0 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 9pa SOCK>3 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 9pa SOCK=0 ETH ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 9pa SOCK>3 ETH ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 9pa SOCK=0 !ETH !INF]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 9pa SOCK>3 !ETH !INF]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 9pa SOCK=0 ETH !INF]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 9pa SOCK>3 ETH !INF]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7vo SOCK=0 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7vo SOCK>3 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7vo SOCK=0 ETH ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7vo SOCK>3 ETH ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7vo SOCK=0 !ETH !INF]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7vo SOCK>3 !ETH !INF]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7vo SOCK=0 ETH !INF]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7vo SOCK>3 ETH !INF]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7vo]:
ItemDisplay[NMAG 7s8 SOCK=0 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7s8 SOCK>3 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7s8 SOCK=0 ETH ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7s8 SOCK>3 ETH ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7s8 SOCK=0 !ETH !INF]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7s8 SOCK>3 !ETH !INF]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7s8 SOCK=0 ETH !INF]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7s8 SOCK>3 ETH !INF]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7s8]:
ItemDisplay[NMAG 7wc SOCK=0 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7wc SOCK>3 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7wc SOCK=0 ETH ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7wc SOCK>3 ETH ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7wc SOCK=0 !ETH !INF]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7wc SOCK>3 !ETH !INF]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7wc SOCK=0 ETH !INF]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7wc SOCK>3 ETH !INF]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7wc]:
ItemDisplay[NMAG 7pa SOCK=0 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7pa SOCK>3 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7pa SOCK=0 ETH ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7pa SOCK>3 ETH ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7pa SOCK=0 !ETH !INF]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7pa SOCK>3 !ETH !INF]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7pa SOCK=0 ETH !INF]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7pa SOCK>3 ETH !INF]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7pa]:
ItemDisplay[NMAG 7h7]:
ItemDisplay[NMAG WP8 SOCK>1 !ETH ILVL<67]:
ItemDisplay[NMAG WP8 SOCK>1 ETH ILVL<67]:
ItemDisplay[NMAG WP8 SOCK>1 ILVL>66]:
ItemDisplay[NMAG WP8 SOCK=0]:
// WP9
ItemDisplay[NMAG cbw SOCK=4]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 6hb SOCK=0 ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 6hb SOCK=4 ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 6hb SOCK=0]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 6hb SOCK=4]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 6cb]:
ItemDisplay[NMAG 6s7 SOCK=0 ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 6s7 SOCK=4 ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 6s7 SOCK=0]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 6s7 SOCK=4]: %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 6s7]:
ItemDisplay[NMAG 6sw]:
ItemDisplay[NMAG 6l7]:
ItemDisplay[NMAG 6lw]:
ItemDisplay[NMAG WP9 SOCK>1 ILVL<67]:
ItemDisplay[NMAG WP9 SOCK>1 ILVL>66]:
ItemDisplay[NMAG WP9 SOCK=0]:
// WP10
ItemDisplay[NMAG 6rx]:
ItemDisplay[NMAG 8rx]:
ItemDisplay[NMAG WP10 SOCK>1 ILVL<67]:
ItemDisplay[NMAG WP10 SOCK>1 ILVL>66]:
ItemDisplay[NMAG WP10 SOCK=0]:
// WP11
ItemDisplay[NMAG 6cs]:
ItemDisplay[NMAG 6bs]:
ItemDisplay[NMAG 6ws]:
ItemDisplay[NMAG WP11 SOCK>1 !ETH ILVL<67]:
ItemDisplay[NMAG WP11 SOCK>1 ETH ILVL<67]:
ItemDisplay[NMAG WP11 SOCK>1 ILVL>66]:
ItemDisplay[NMAG WP11 SOCK=0 !ETH ILVL<67]:
ItemDisplay[NMAG WP11 SOCK=0 ETH ILVL<67]:
ItemDisplay[NMAG WP11 SOCK=0 ILVL>66]:
// WP12
ItemDisplay[NMAG WP12 SOCK>1 !ETH ILVL<67]:
ItemDisplay[NMAG WP12 SOCK>1 ETH ILVL<67]:
ItemDisplay[NMAG WP12 SOCK>1 ILVL>66]:
ItemDisplay[NMAG WP12 SOCK=0 !ETH ILVL<67]:
ItemDisplay[NMAG WP12 SOCK=0 ETH ILVL<67]:
ItemDisplay[NMAG WP12 SOCK=0 ILVL>66]:
// WP13
ItemDisplay[NMAG wsp]:
ItemDisplay[NMAG 7qs]:
ItemDisplay[NMAG 7ws SOCK=0 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7ws SOCK>2 !ETH ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7ws SOCK=0 ETH ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7ws SOCK>2 ETH ED>9]: %WHITE%ETH %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG 7ws]:
ItemDisplay[NMAG WP13 SOCK>1 !ETH ILVL<67]:
ItemDisplay[NMAG WP13 SOCK>1 ETH ILVL<67]:
ItemDisplay[NMAG WP13 SOCK>1 ILVL>66]:
ItemDisplay[NMAG WP13 SOCK=0 !ETH ILVL<67]:
ItemDisplay[NMAG WP13 SOCK=0 ETH ILVL<67]:
ItemDisplay[NMAG WP13 SOCK=0 ILVL>66]:
// Catchall
ItemDisplay[NMAG WEAPON SOCK=0 !ETH ELT ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG WEAPON SOCK>3 !ETH ELT ED>9]: %DGREEN%%NAME% %ORANGE%Damages %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG WEAPON SOCK=0 ETH ELT ED>9]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
ItemDisplay[NMAG WEAPON SOCK>3 ETH ELT ED>9]: %WHITE%ETH %DGREEN%%NAME% %RED%[%SOCKETS%] %TAN%[%ILVL%]
//
//╔═════════════╗
//║ White Items ║
//╚═════════════╝
//
//Money
ItemDisplay[NMAG (wnd OR ywn OR 9wn) (SK83>2 OR SK85>2 OR SK87>2 OR SK88>2 OR SK90>1)]: %WHITE%Sell Me > %GOLD%%PRICE%%WHITE%$
ItemDisplay[NMAG (wnd OR ywn OR 9wn) (SK91>1 OR SK92>0 OR SK93>1 OR SK94>1 OR SK95>0)]: %WHITE%Sell Me > %GOLD%%PRICE%%WHITE%$
//NMAG Cleaner
ItemDisplay[NMAG SOCK=1]:
ItemDisplay[NMAG INF]:
ItemDisplay[NMAG EQ4]:
ItemDisplay[NMAG EQ5]:
ItemDisplay[NMAG EQ6]:
ItemDisplay[NMAG WP5]:
ItemDisplay[NMAG WP6]:
//
//╔══════════════╗
//║ Gears Unique ║
//╚══════════════╝
//
ItemDisplay[UNI !ID rin]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID amu]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID jew]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID cm1]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID cm2]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID cm3]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
// EQ1
ItemDisplay[UNI !ID uhm !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID uap !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID usk !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID urn !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID xh9 !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID ulm !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID xhm !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI ETH !ID uhm]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI ETH !ID uap]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI ETH !ID usk]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI ETH !ID urn]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI ETH !ID xh9]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI ETH !ID ulm]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI ETH !ID xhm]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
// EQ2
ItemDisplay[UNI !ID uar !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID uui !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID xhn !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID upl !ETH]: %RED%¤¤¤¤¤¤¤ %GOLD%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID xea !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID xlt !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID xpl !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID utu !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID uld !ETH]: %RED%¤¤¤¤¤¤¤ %GOLD%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID xrs !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID stu !ETH]: %RED%¤¤¤¤¤¤¤ %GOLD%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID uar ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID xpl ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID xea ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID utu ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID upl ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID xlt ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID uui ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID xhn ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
// EQ3
ItemDisplay[UNI !ID uit !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID xow !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID uow !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID xsh !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID uit ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID uow ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID xsh ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID xow ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
// EQ4
ItemDisplay[UNI !ID uvg !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID hgl !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID tgl !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID xtg !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID xmg !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID uhg !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID mgl !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID tgl ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID uvg ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID uhg ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID xtg ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
// EQ5
ItemDisplay[UNI !ID xtb !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID xhb !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID xmb !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID uvb !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID lbt !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID uhb !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID xvb !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID umb !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID uvb ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID uhb ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID umb ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID xtb ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID xhb ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID lbt ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
// EQ6
ItemDisplay[UNI !ID ulc !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID umc !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID zhb !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID zlb !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID zvb !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID uvc !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID ulc ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID umc ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID uvc ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID zhb ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID zlb ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
// EQ7
ItemDisplay[UNI !ID ci3 !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID ci2 !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID ci3 ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID ci2 ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
//
//╔════════════════╗
//║ Weapons Unique ║
//╚════════════════╝
//
// WP1
ItemDisplay[UNI !ID 7wa !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
// WP2
//
// WP3
ItemDisplay[UNI !ID 7cr]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID 7gd !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID 9fc !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID 9bs !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
// WP4
ItemDisplay[UNI !ID 7kr !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
// WP5
ItemDisplay[UNI !ID 7bk !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID 7b8 !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID 7bk ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID 7b8 ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
// WP6
//
// WP7
//
// WP8
ItemDisplay[UNI !ID 7s8 !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID 7pa !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID 7o7 !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID 7pa ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID 7o7 ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
// WP9
ItemDisplay[UNI !ID 6lw]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
// WP10
ItemDisplay[UNI !ID rxb]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID 8hx]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
// WP11
ItemDisplay[UNI !ID 6ws !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID 6cs !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID 8ls !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID 6ws ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID 6cs ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
// WP12
ItemDisplay[UNI !ID 7gw !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID 9bw !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID 7gw ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID 9bw ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
// WP13
ItemDisplay[UNI !ID 7sc !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID 7ws !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID 7sc ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID 7ws ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
//
//╔════════════════╗
//║ Classes Unique ║
//╚════════════════╝
//
// CL1
ItemDisplay[UNI !ID dra !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID dre !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID dra ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID dre ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
// CL2
ItemDisplay[UNI !ID baa !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID bac !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID bae !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID baa ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID bac ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID bae ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
// CL3
ItemDisplay[UNI !ID pac !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID pa9 !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID pac ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID pa9 ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
// CL4
ItemDisplay[UNI !ID nea !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID nef !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID nee !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID nea ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID nef ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID nee ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
// CL5
ItemDisplay[UNI !ID 9tw !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
// CL6
ItemDisplay[UNI !ID obf !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID obc !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID oba !ETH]: %RED%¤¤¤¤¤¤¤ %PURPLE%%NAME% %RED%¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID obf ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID obc ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID oba ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
// CL7
ItemDisplay[UNI !ID ama !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID amf !ETH]: %GREEN%¤¤¤¤¤¤¤¤¤¤ %PURPLE%%NAME% %GREEN%¤¤¤¤¤¤¤¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID ama ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
ItemDisplay[UNI !ID amf ETH]: %RED%¤¤¤ %WHITE%ETH %ORANGE%%NAME% %RED%¤¤¤ %TAN%[%ILVL%]
// UNI Catchall
ItemDisplay[UNI !ID !ETH]: %NAME% %TAN%[%ILVL%]
ItemDisplay[UNI !ID ETH]: %WHITE%ETH %GOLD%%NAME% %TAN%[%ILVL%]
//End of Loot Filter
//
//
//
